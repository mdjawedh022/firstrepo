    ...
    <>
      ...
      >
        <Box>
          ...
          <Box borderWidth={"1px"} padding={"20px"} borderRadius={"5px"}>
            ...
            <FormControl id="" isRequired>
              <FormLabel fontSize={'16px'}>House no./Building Name</FormLabel>
              <Input type="text" height={'40px'} />
            </FormControl>
            <FormControl id="" isRequired>
              <FormLabel fontSize={'16px'}>Road Name/Area/Colony</FormLabel>
              <Input type="text" height={'40px'}/>
            </FormControl>
            <FormControl id="" isRequired>
              <FormLabel fontSize={'16px'}>Pincode</FormLabel>
              <Input type="number" height={'40px'}/>
            </FormControl>
            <HStack>
              <Box>
                <FormControl id="" isRequired>
                  <FormLabel fontSize={'16px'}>City</FormLabel>
                  <Input type="text" height={'40px'}/>
                </FormControl>
              </Box>
              <Box>
                <FormControl id="">
                  <FormLabel fontSize={'16px'}>State</FormLabel>
                  <Input type="text" height={'40px'}/>
                </FormControl>
              </Box>
            </HStack>
            <FormControl id="" isRequired>
              <FormLabel fontSize={'16px'}>Nearby Location(option)</FormLabel>
              <Input type="number" height={'40px'}/>
            </FormControl>
