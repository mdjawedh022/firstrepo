  ...
  return (
    <>
      ...
      color={'white'}
        ...
        backgroundImage={
          "linear-gradient(300deg,#8f34c0,#5968f2,#541ec9,#8f34c0)"
        }
        mt="20px"
        padding={"30px"}
      ...
      >
        <Box>
          <Text fontSize={{ base: "45px", md: "50px", lg: "50px" }}  marginBottom="15px">Skills</Text>
          <Box
            display={"grid"}
            gridTemplateColumns={{ base: "repeat(2,1fr)", md: "repeat(4,1fr)", lg: "repeat(5,1fr)" }}
            gap="10px"
            w={{base:'',md:"80%",lg:"60%"}}
            margin={'auto'}
            fontWeight={"600"}
        ...
        <Box mt="10px">
        <Text fontSize={{ base: "45px", md: "50px", lg: "50px" }} marginBottom="15px">Tools</Text>
          <Box
            display={"grid"}
            gridTemplateColumns={{ base: "repeat(2,1fr)", md: "repeat(4,1fr)", lg: "repeat(3,1fr)" }}
            gap="10px"
            w={{base:'',md:"80%",lg:"37%"}}
            margin={'auto'}
            fontWeight={"600"}
