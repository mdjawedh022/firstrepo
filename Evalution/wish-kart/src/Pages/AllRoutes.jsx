...
import ProductDetailPageNew from "./allProducts/ProductDetailPageNew.jsx";
...
export default function AllRoutes() {
  ...
  return (
    <Routes>
      {/* <Route path="/SingleProduct/:id" element={<SingleProduct props={p}/>} /> */}
      <Route path="/SingleProduct/:id" element={<ProductDetailPageNew />} />
