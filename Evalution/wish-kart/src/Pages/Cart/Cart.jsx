        ...
        <div className="cart-first-section">
          ...
          >
            ...
            <Box>
              ...
              <Flex 
               fontSize={"15px"}
              gap={"20px"} fontWeight={"500"}>
                <Text>Size: s</Text>
                <Text>Qty: 1</Text>
              </Flex>
              <Text fontSize={"15px"} m={"10px auto"} fontWeight={"500"}>
                ₹2023
              </Text>
              <Button
               fontSize={"15px"}
              ...
              >
                <i style={{color:"pink.600"}} className="fa-solid fa-xmark"></i>Remove
              </Button>
            </Box>
          </Card>
          <Flex
        ...
        <div className="cart-second-section">
          <Box borderLeft={"2px solid rgb(148, 137, 137)"} padding={"10px"}>
            ...
            <Button
              bg={"pink.400"}
              fontSize={"20px"}
              padding={{ base: "20px 85px", md: "20px 260px", lg: "20px 147px" }}
              color={"white"}
              borderRadius={"5px"}
              m={"10px auto"}
              _hover={{ bg: "pink.450" }}
