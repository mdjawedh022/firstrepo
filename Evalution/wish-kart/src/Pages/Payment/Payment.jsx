      ...
      >
        <Box>
          ...
          fontSize={"15px"}
            ...
            gap={{ base: "122px", md: "420px", lg: "280px" }}
            padding={"25px 14px"}
            bg={"green.100"}
            _hover={{ bg: "green.100" }}
          >
            <Text fontSize={"15px"}>Cash on Delivery</Text>{" "}
            <Checkbox
              colorScheme="green"
              defaultChecked
              border={"white"}
        ...
        <Box padding={"10px"}>
          ...
          <Button
            fontSize={"10px"}
            outline={"none"}
            padding={{ base: "10px 28px", md: "1px 182px", lg: "1px 69px" }}
            m={"10px auto"}
          >
          ...
          fontSize={"20px"}
            bg={"pink.400"}
            padding={{ base: "20px 105px", md: "20px 260px", lg: "20px 147px" }}
            color={"white"}
            borderRadius={"5px"}
            m={"10px auto"}
            _hover={{ bg: "pink.450" }}
