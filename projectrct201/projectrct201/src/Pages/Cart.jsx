  ...
  return (
    <Center p={"15px 30px"}>
      <Stack
        ...
        bg={useColorModeValue("white", "gray.1100")}
      >
        ...
        <Stack FlexDirection={"row"} >
          ...
          <Box borderWidth={'1px'}>
            ...
            <Flex alignItems={"center"} gap={"10px"}>
              <Button borderRadius={"10px"} padding={"5px 15px"}bg={"white"} borderWidth={'1px'}>S</Button>
              <Button borderRadius={"10px"} padding={"5px 15px"} bg={"white"} borderWidth={'1px'}>M</Button>
              <Button borderRadius={"10px"} padding={"5px 15px"} bg={"white"} borderWidth={'1px'}>XL</Button>
              <Button borderRadius={"10px"} padding={"5px 15px"} bg={"white"} borderWidth={'1px'}>L</Button>
              <Button borderRadius={"10px"} padding={"5px 15px"} bg={"white"} borderWidth={'1px'}>XXL</Button>
            </Flex>
          </Box>
        </Stack>
      </Stack>
