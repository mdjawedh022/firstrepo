   ...
   <>
    <Box
        ...
        >
          ...
          <Box display={"flex"} alignItems="center" gap="7px" fontSize={"12px"}>
            ...
            <PopoverContent w='200px' fontSize={'14px'}>
            <Text p="8px 15px"fontWeight={"600"}>Help</Text>
              <PopoverBody p="8px 15px">
              <Text>Order Status</Text>
              <Text></Text>
              <Text>Dispatch and Delivery</Text>
              <Text>Return</Text>
              <Text>Contact Us</Text>
              <Text>Private Policy</Text>
              <Text>Terms of Sales</Text>
